...
BEGIN
  IDS_SELECT_INT_FUNCTION_ROM   "Vælg image for intern funktions-ROM"
  IDS_SELECT_EXT_FUNCTION_ROM   "Vælg image for ekstern funktions-ROM"
  ...
  IDS_C128_FULL_BANKS           "Aktivér RAM-bank 2 og 3"
...
BEGIN
  IDS_SELECT_INT_FUNCTION_ROM   "Internes Funktions ROM Image Datei auswählen"
  IDS_SELECT_EXT_FUNCTION_ROM   "Externes Funktions ROM Image Datei auswählen"
  IDS_MACHINE_TYPE              "Maschinen Typ"
  IDS_FUNCTION_ROM              "Function ROM"
  IDS_RAM_BANKS                 "RAM Bänke"
  ...
  IDS_FRENCH_KERNAL             "Französischer Kernal"
  ...
  IDS_FRENCH_CHARACTER          "Französischer Zeichensatz"
  ...
  IDS_C128_FULL_BANKS           "RAM Bänke 2 und 3 aktivieren"
...
BEGIN
  IDS_SELECT_INT_FUNCTION_ROM   "Seleccionar fichero ROM función interno"
  IDS_SELECT_EXT_FUNCTION_ROM   "Seleccionar fichero ROM función externo"
  IDS_MACHINE_TYPE              "Tipo de máquina"
  IDS_FUNCTION_ROM              "ROM función"
  ...
  IDS_GERMAN_KERNAL             "Kernal alemán"
  IDS_FINNISH_KERNAL            "Kernal finlandés"
  IDS_FRENCH_KERNAL             "Kernal francés"
  ...
  IDS_MP_VDC_REVISION           "Revisión VDC"
  IDS_MI_TOGGLE_VDC64KB         "Memoria de video 64KB"
  IDS_MI_IEEE488                "Emulación de interface IEEE488"
...
BEGIN
  IDS_SELECT_INT_FUNCTION_ROM   "Sélectionner le fichier image ROM Fonction interne"
  IDS_SELECT_EXT_FUNCTION_ROM   "Sélectionner le fichier image ROM Fonction externe"
  IDS_MACHINE_TYPE              "Type de machine"
  IDS_FUNCTION_ROM              "ROM Fonction"
  IDS_RAM_BANKS                 "Banques de RAM"
  IDS_C128_SETTINGS             "Paramètres C128"
  IDS_KERNAL_INT                "Kernal Int."
  IDS_KERNAL_DE                 "Kernal DE"
  IDS_KERNAL_FI                 "Kernal FI"
  IDS_KERNAL_FR                 "Kernal FR"
  ...
  IDS_FRENCH_KERNAL             "Kernal français"
  IDS_ITALIAN_KERNAL            "Kernal italien"
  IDS_NORWEGIAN_KERNAL          "Kernal norvégien"
  IDS_SWEDISH_KERNAL            "Kernal suédois"
  IDS_INTERNATIONAL_CHARACTER   "Jeu de caractères international"
  IDS_GERMAN_CHARACTER          "Jeu de caractères allemand"
  IDS_FRENCH_CHARACTER          "Jeu de caractères français"
  IDS_SWEDISH_CHARACTER         "Jeu de caractères suédois"
  ...
  IDS_C128MODEL                 "Modèle C128"
  IDS_MP_VDC_SETTINGS           "Paramètres VDC"
  IDS_MP_VDC_REVISION           "Révision VDC"
  IDS_MI_TOGGLE_VDC64KB         "Mémoire vidéo de 64Ko"
  IDS_MI_IEEE488                "Interface d'émulation IEEE488"
  IDS_MI_C128_SETTINGS          "Paramètres C128..."
  IDS_MI_C128MODEL_SETTINGS     "Paramètres du modèle C128..."
END
...
BEGIN
  IDS_SELECT_INT_FUNCTION_ROM   "Adja meg a belsõ Function ROM képmás nevét"
  IDS_SELECT_EXT_FUNCTION_ROM   "Adja meg a külsõ Function ROM képmás nevét"
  IDS_MACHINE_TYPE              "Gép típus"
  IDS_FUNCTION_ROM              "Function ROM"
  IDS_RAM_BANKS                 "RAM bankok"
  IDS_C128_SETTINGS             "C128 beállításai"
  IDS_KERNAL_INT                "Kernal Int."
  IDS_KERNAL_DE                 "Kernal DE"
  IDS_KERNAL_FI                 "Kernal FI"
  IDS_KERNAL_FR                 "Kernal FR"
  ...
  IDS_KERNAL_C64                "Kernal C64"
  IDS_BASIC_C64                 "Basic C64"
  IDS_INTERNATIONAL_KERNAL      "Nemzetközi kernal"
  IDS_GERMAN_KERNAL             "Német kernal"
  IDS_FINNISH_KERNAL            "Finn kernal"
  IDS_FRENCH_KERNAL             "Francia kernal"
  IDS_ITALIAN_KERNAL            "Olasz kernal"
  IDS_NORWEGIAN_KERNAL          "Norvég kernal"
  IDS_SWEDISH_KERNAL            "Svéd kernal"
  IDS_INTERNATIONAL_CHARACTER   "Nemzetközi karakterkészlet"
  IDS_GERMAN_CHARACTER          "Német karakterkészlet"
  IDS_FRENCH_CHARACTER          "Francia karakterkészlet"
  IDS_SWEDISH_CHARACTER         "Svéd karakterkészlet"
  IDS_C64_MODE_KERNAL           "C64 mód kernal"
  IDS_C64_MODE_BASIC            "C64 mód Basic"
  IDS_INTERNATIONAL             "Nemzetközi"
  IDS_FINNISH                   "Finn"
  IDS_FRENCH                    "Francia"
  IDS_GERMAN                    "Német"
  IDS_ITALIAN                   "Olasz"
  IDS_NORWEGIAN                 "Norvég"
  IDS_SWEDISH                   "Svéd"
  IDS_INT_FUNCTION_ROM          "Belsõ Function ROM"
  IDS_INT_FUNCTION_ROM_TYPE     "Internal Function ROM type"
  IDS_FILE_NAME                 "Fájlnév"
  IDS_EXT_FUNCTION_ROM          "Külsõ Function ROM"
  IDS_EXT_FUNCTION_ROM_TYPE     "External Function ROM type"
  IDS_C128_FULL_BANKS           "2-es és 3-as RAM bankok engedélyezése"
  IDS_C128MODEL                 "C128 model"
  IDS_MP_VDC_SETTINGS           "VDC beállításai"
  IDS_MP_VDC_REVISION           "VDC változat"
  IDS_MI_TOGGLE_VDC64KB         "64KB képernyõ memória"
  IDS_MI_IEEE488                "IEEE488 Interface emulation"
  IDS_MI_C128_SETTINGS          "C128 beállításai..."
...
BEGIN
  ...
  IDS_C64_MODE_KERNAL           "Kernel in modalità C64"
  IDS_C64_MODE_BASIC            "Basic in modalità C64"
...
BEGIN
  IDS_SELECT_INT_FUNCTION_ROM   "Wybierz plik wewnêtrznego Function ROM-u"
  IDS_SELECT_EXT_FUNCTION_ROM   "Wybierz plik zewnêtrznego Function ROM-u"
  ...
  IDS_KERNAL_C64                "Kernal C64"
  IDS_BASIC_C64                 "Basic C64"
  IDS_INTERNATIONAL_KERNAL      "Miêdzynarodowy Kernal"
  IDS_GERMAN_KERNAL             "Niemiecki Kernal"
  IDS_FINNISH_KERNAL            "Fiñski Kernal"
  ...
  IDS_INTERNATIONAL_CHARACTER   "Znak miêdzynarodowy"
  ...
  IDS_INTERNATIONAL             "Miêdzynarodowy"
  IDS_FINNISH                   "Fiñski"
  ...
  IDS_INT_FUNCTION_ROM          "Wewnêtrzny Function ROM"
  IDS_INT_FUNCTION_ROM_TYPE     "Typ wewnêtrznego Function ROM-u"
  IDS_FILE_NAME                 "Nazwa pliku"
  IDS_EXT_FUNCTION_ROM          "Zewnêtrzny Function ROM"
  IDS_EXT_FUNCTION_ROM_TYPE     "Typ zewnêtrznego Function ROM-u"
  ...
  IDS_MI_TOGGLE_VDC64KB         "Pamiêæ wideo 64KB"
...
BEGIN
  IDS_SELECT_INT_FUNCTION_ROM   "Select Internal Function ROM file"
  IDS_SELECT_EXT_FUNCTION_ROM   "Select External Function ROM file"
  IDS_MACHINE_TYPE              "ÂØß ÚÞÜßìîâÕàÐ"
  IDS_FUNCTION_ROM              "ÄãÝÚæØÞÝÐÛìÝÞÕ ¿·Ã"
  IDS_RAM_BANKS                 "RAM banks"
  IDS_C128_SETTINGS             "½ÐáâàÞÙÚØ C128"
  IDS_KERNAL_INT                "Kernal Int."
  IDS_KERNAL_DE                 "Kernal DE"
  IDS_KERNAL_FI                 "Kernal FI"
  IDS_KERNAL_FR                 "Kernal FR"
  ...
  IDS_C64_MODE_KERNAL           "C64 mode Kernal"
  IDS_C64_MODE_BASIC            "C64 mode Basic"
  IDS_INTERNATIONAL             "ÜÕÖÔãÝÐàÞÔÝëÙ"
  IDS_FINNISH                   "äØÝáÚØÙ"
  IDS_FRENCH                    "äàÐÝæã×áÚØÙ"
  IDS_GERMAN                    "ÝÕÜÕæÚØÙ"
  IDS_ITALIAN                   "ØâÐÛìïÝáÚØÙ"
  IDS_NORWEGIAN                 "ÝÞàÒÕÖáÚØÙ"
  IDS_SWEDISH                   "èÒÕÔáÚØÙ"
  IDS_INT_FUNCTION_ROM          "Internal Function ROM"
  IDS_INT_FUNCTION_ROM_TYPE     "Internal Function ROM type"
  IDS_FILE_NAME                 "¸Üï äÐÙÛÐ"
  IDS_EXT_FUNCTION_ROM          "External Function ROM"
  IDS_EXT_FUNCTION_ROM_TYPE     "External Function ROM type"
  IDS_C128_FULL_BANKS           "Enable RAM banks 2 and 3"
  IDS_C128MODEL                 "C128 model"
  IDS_MP_VDC_SETTINGS           "½ÐáâàÞÙÚØ VDC"
  IDS_MP_VDC_REVISION           "VDC revision"
  IDS_MI_TOGGLE_VDC64KB         "64KB video memory"
  IDS_MI_IEEE488                "IEEE488 Interface emulation"
  IDS_MI_C128_SETTINGS          "½ÐáâàÞÙÚØ C128..."
  IDS_MI_C128MODEL_SETTINGS     "C128 model settings..."
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
...
BEGIN
  IDS_SELECT_INT_FUNCTION_ROM   "Välj avbildning för internt funktions-ROM"
  IDS_SELECT_EXT_FUNCTION_ROM   "Välj avbildning för externt funktions-ROM"
  IDS_MACHINE_TYPE              "Maskintyp"
  IDS_FUNCTION_ROM              "Funktions-ROM"
  IDS_RAM_BANKS                 "RAM-bankar"
  IDS_C128_SETTINGS             "C128-inställningar"
  IDS_KERNAL_INT                "Kernal int."
  IDS_KERNAL_DE                 "Kernal DE"
  IDS_KERNAL_FI                 "Kernal FI"
  IDS_KERNAL_FR                 "Kernal FR"
  ...
  IDS_KERNAL_NO                 "Kernal NO"
  IDS_KERNAL_SE                 "Kernal SE"
  IDS_BASIC_LO                  "Basic LÅ"
  IDS_BASIC_HI                  "Basic HÖ"
  ...
  IDS_C64_MODE_KERNAL           "Kernal för C64-läge"
  IDS_C64_MODE_BASIC            "Basic för C64-läge"
  ...
  IDS_C128MODEL                 "C128-modell"
  IDS_MP_VDC_SETTINGS           "VDC-inställningar"
  IDS_MP_VDC_REVISION           "VDC-revision"
  IDS_MI_TOGGLE_VDC64KB         "64KB grafikminne"
  IDS_MI_IEEE488                "Emulering av IEEE488-gränssnitt"
  IDS_MI_C128_SETTINGS          "C128-inställningar..."
  IDS_MI_C128MODEL_SETTINGS     "C128-modellinställningar..."
END
...
BEGIN
  IDS_SELECT_INT_FUNCTION_ROM   "Dahili Function ROM dosyasý seçin"
  IDS_SELECT_EXT_FUNCTION_ROM   "Harici Function ROM dosyasý seçin"
  IDS_MACHINE_TYPE              "Makine tipi"
  IDS_FUNCTION_ROM              "Function ROM"
  IDS_RAM_BANKS                 "RAM banklarý"
  IDS_C128_SETTINGS             "C128 ayarlarý"
  IDS_KERNAL_INT                "Uluslararasý Kernal"
  IDS_KERNAL_DE                 "Kernal DE"
  IDS_KERNAL_FI                 "Kernal FI"
  IDS_KERNAL_FR                 "Kernal FR"
  IDS_KERNAL_IT                 "Kernal IT"
  ...
  IDS_BASIC_LO                  "Basic LO"
  IDS_BASIC_HI                  "Basic HI"
  IDS_CHAR_INT                  "Uluslararasý Karakter"
  IDS_CHAR_DE                   "Karakter DE"
  IDS_CHAR_FR                   "Karakter FR"
  IDS_CHAR_SE                   "Karakter SE"
  IDS_KERNAL_C64                "Kernal C64"
  IDS_BASIC_C64                 "Basic C64"
  IDS_INTERNATIONAL_KERNAL      "Uluslararasý Kernal"
  IDS_GERMAN_KERNAL             "Alman Kernal"
  IDS_FINNISH_KERNAL            "Finlandiya Kernal"
  IDS_FRENCH_KERNAL             "Fransýz Kernal"
  IDS_ITALIAN_KERNAL            "Ýtalyan Kernal"
  IDS_NORWEGIAN_KERNAL          "Norveç Kernal"
  IDS_SWEDISH_KERNAL            "Ýsveç Kernal"
  IDS_INTERNATIONAL_CHARACTER   "Uluslararasý Karakter"
  IDS_GERMAN_CHARACTER          "Alman Karakter"
  IDS_FRENCH_CHARACTER          "Fransýz Karakter"
  IDS_SWEDISH_CHARACTER         "Ýsveç Karakter"
  IDS_C64_MODE_KERNAL           "C64 modu Kernal"
  IDS_C64_MODE_BASIC            "C64 modu Basic"
  IDS_INTERNATIONAL             "Uluslararasý"
  IDS_FINNISH                   "Fince"
  IDS_FRENCH                    "Fransýzca"
  IDS_GERMAN                    "Almanca"
  IDS_ITALIAN                   "Ýtalyanca"
  IDS_NORWEGIAN                 "Norveççe"
  IDS_SWEDISH                   "Ýsveççe"
  IDS_INT_FUNCTION_ROM          "Uluslararasý Function ROM"
  IDS_INT_FUNCTION_ROM_TYPE     "Dahili Function ROM tipi"
  IDS_FILE_NAME                 "Dosya ismi"
  IDS_EXT_FUNCTION_ROM          "Harici Function ROM"
  IDS_EXT_FUNCTION_ROM_TYPE     "External Function ROM type"
  IDS_C128_FULL_BANKS           "RAM banklarý 2 ve 3'ü aktif et"
  IDS_C128MODEL                 "C128 modeli"
  IDS_MP_VDC_SETTINGS           "VDC ayarlarý"
  IDS_MP_VDC_REVISION           "VDC revizyonu"
  IDS_MI_TOGGLE_VDC64KB         "64KB görüntü belleði"
  IDS_MI_IEEE488                "IEEE488 Arabirimi emülasyonu"
  IDS_MI_C128_SETTINGS          "C128 ayarlarý..."
  IDS_MI_C128MODEL_SETTINGS     "C128 model ayarlarý..."
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
#endif
