...
BEGIN
    ...
    AUTORADIOBUTTON "", IDC_SELECT_CBMII_HW2,
                    25,60,65,10, BS_AUTORADIOBUTTON
END
...
BEGIN
  ...
  IDS_CBM2MODEL               N_("CBM2 model")
  IDS_MI_CBM2_SETTINGS        N_("CBM2 settings")
  IDS_MI_CBM2MODEL_SETTINGS   N_("CBM2 model settings")
END
...
BEGIN
  ...
  IDS_CBM2MODEL               "CBM2-model"
  IDS_MI_CBM2_SETTINGS        "CBM2-indstillinger..."
  IDS_MI_CBM2MODEL_SETTINGS   "CBM2-modelindstillinger..."
END
...
BEGIN
  ...
  IDS_CBM2MODEL               "CBM2 Modell"
  IDS_MI_CBM2_SETTINGS        "CBM2 Einstellungen..."
  IDS_MI_CBM2MODEL_SETTINGS   "CBM2 Modell Einstellungen..."
END
...
BEGIN
  IDS_CBM2_SETTINGS           "Ajustes CBM2"
  IDS_CBM2MODEL               "Modelo CBM2"
  IDS_MI_CBM2_SETTINGS        "Ajustes CBM2..."
  IDS_MI_CBM2MODEL_SETTINGS   "Ajustes modelo CBM2..."
END
...
BEGIN
  IDS_CBM2_SETTINGS           "Paramètres CBM2"
  IDS_CBM2MODEL               "Modèle CBM2"
  IDS_MI_CBM2_SETTINGS        "Paramètres CBM2..."
  IDS_MI_CBM2MODEL_SETTINGS   "Paramètres du modèle CBM2..."
END
...
BEGIN
  IDS_CBM2_SETTINGS           "CBM2 beállításai"
  IDS_CBM2MODEL               "CBM2 model"
  IDS_MI_CBM2_SETTINGS        "CBM2 beállításai..."
  IDS_MI_CBM2MODEL_SETTINGS   "CBM2 model settings..."
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
#endif
...
BEGIN
  ...
  IDS_CBM2MODEL               "Modello CBM2"
  IDS_MI_CBM2_SETTINGS        "Impostazioni CBM2..."
  IDS_MI_CBM2MODEL_SETTINGS   "Impostazioni modello CBM2..."
END
...
BEGIN
  ...
  IDS_MI_CBM2MODEL_SETTINGS   "CBM2 model instellingen..."
END
...
BEGIN
  IDS_CBM2_SETTINGS           "Ustawienia CBM2"
  IDS_CBM2MODEL               "Model CBM2"
  IDS_MI_CBM2_SETTINGS        "Ustawienia CBM2..."
  IDS_MI_CBM2MODEL_SETTINGS   "Ustawienia modelu CBM2..."
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
#endif
...
BEGIN
  IDS_CBM2_SETTINGS           "CBM2-inställningar"
  IDS_CBM2MODEL               "CBM2-modell"
  IDS_MI_CBM2_SETTINGS        "CBM2-inställningar..."
  IDS_MI_CBM2MODEL_SETTINGS   "CBM2-modellinställningar..."
END
...
BEGIN
  IDS_CBM2_SETTINGS           "CBM2 ayarlarý"
  IDS_CBM2MODEL               "CBM2 modeli"
  IDS_MI_CBM2_SETTINGS        "CBM2 ayarlarý..."
  IDS_MI_CBM2MODEL_SETTINGS   "CBM2 model ayarlarý..."
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
#endif
