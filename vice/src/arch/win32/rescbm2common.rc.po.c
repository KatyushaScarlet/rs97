...
BEGIN
  ...
  IDS_ATTACH_CBM2_CART_1000        "Tilslut cartridge image på $1000"
  IDS_ATTACH_CBM2_CART_2000_3000   "Tilslut cartridge image på $2000/$3000"
  IDS_ATTACH_CBM2_CART_4000_5000   "Tilslut cartridge image på $4000/$5000"
  IDS_ATTACH_CBM2_CART_6000_7000   "Tilslut cartridge image på $6000/$7000"
  IDS_MI_LOAD_CART_1000            "Indlæs nyt cartridge $1***"
  IDS_MI_UNLOAD_CART_1000          "Afbryd cartridge $1***"
  IDS_MI_LOAD_CART_2000_3000       "Indlæs nyt cartridge $2-3***"
  IDS_MI_UNLOAD_CART_2000_3000     "Afbryd cartridge $2-3***"
  IDS_MI_LOAD_CART_4000_5000       "Indlæs nyt cartridge $4-5***"
  IDS_MI_UNLOAD_CART_4000_5000     "Afbryd cartridge $4-5***"
  IDS_MI_LOAD_CART_6000_7000       "Indlæs nyt cartridge $6-7***"
...
BEGIN
  IDS_MODEL_LINE                   "Ligne du modèle"
  ...
  IDS_ATTACH_CBM2_CART_1000        "Attacher une image de cartouche à $1000"
  IDS_ATTACH_CBM2_CART_2000_3000   "Attacher une image de cartouche à $2000/$3000"
  IDS_ATTACH_CBM2_CART_4000_5000   "Attacher une image de cartouche à $4000/$5000"
  IDS_ATTACH_CBM2_CART_6000_7000   "Attacher une image de cartouche à $6000/$7000"
  IDS_MI_LOAD_CART_1000            "Charger la cartouche $1***"
  IDS_MI_UNLOAD_CART_1000          "Décharger la cassette $1***"
  IDS_MI_LOAD_CART_2000_3000       "Charger la cartouche $2-3***"
  IDS_MI_UNLOAD_CART_2000_3000     "Décharger la cassette $2-3***"
  IDS_MI_LOAD_CART_4000_5000       "Charger la cartouche $4-5***"
  IDS_MI_UNLOAD_CART_4000_5000     "Décharger la cassette $4-5***"
  IDS_MI_LOAD_CART_6000_7000       "Charger la cartouche $6-7***"
  IDS_MI_UNLOAD_CART_6000_7000     "Décharger la cassette $6-7***"
END
...
BEGIN
  ...
  IDS_MI_LOAD_CART_1000            "Új Cart. betöltése a $1*** címre"
  IDS_MI_UNLOAD_CART_1000          "Cart. leválasztása a $1*** címrõl"
  IDS_MI_LOAD_CART_2000_3000       "Új Cart. betöltése a $2-$3*** címre"
  IDS_MI_UNLOAD_CART_2000_3000     "Cart. leválasztása a $2-3*** címrõl"
  IDS_MI_LOAD_CART_4000_5000       "Új Cart. betöltése a $4-$5*** címre"
  IDS_MI_UNLOAD_CART_4000_5000     "Cart. leválasztása a $4-5*** címrõl"
  IDS_MI_LOAD_CART_6000_7000       "Új Cart. betöltése a $6-$7*** címre"
  IDS_MI_UNLOAD_CART_6000_7000     "Cart. leválasztása a $6-7*** címrõl"
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
#endif
...
BEGIN
  ...
  IDS_TOGGLE_CBMII_RAM08           "¹ðÅ© 15 $0800-$0FFF RAM"
  IDS_TOGGLE_CBMII_RAM1            "¹ðÅ© 15 $1000-$1FFF RAM"
  IDS_TOGGLE_CBMII_RAM2            "¹ðÅ© 15 $2000-$3FFF RAM"
  IDS_TOGGLE_CBMII_RAM4            "¹ðÅ© 15 $4000-$5FFF RAM"
  IDS_TOGGLE_CBMII_RAM6            "¹ðÅ© 15 $6000-$7FFF RAM"
  IDS_TOGGLE_CBMII_RAMC            "¹ðÅ© 15 $C000-$CFFF RAM"
  IDS_ATTACH_CBM2_CART_1000        "Attach cartridge image at $1000"
  IDS_ATTACH_CBM2_CART_2000_3000   "Attach cartridge image at $2000/$3000"
  IDS_ATTACH_CBM2_CART_4000_5000   "Attach cartridge image at $4000/$5000"
  IDS_ATTACH_CBM2_CART_6000_7000   "Attach cartridge image at $6000/$7000"
...
BEGIN
  ...
  IDS_SELECT_CBMII_MEM_128         "128 kBajtów"
  IDS_SELECT_CBMII_MEM_256         "256 kBajtów"
  IDS_SELECT_CBMII_MEM_512         "512 kBajtów"
  ...
  IDS_TOGGLE_CBMII_RAM6            "Bank 15 $6000-$7FFF RAM"
  IDS_TOGGLE_CBMII_RAMC            "Bank 15 $C000-$CFFF RAM"
  IDS_ATTACH_CBM2_CART_1000        "Wsuñ obraz kartrid¿a w $1000"
  IDS_ATTACH_CBM2_CART_2000_3000   "Wsuñ obraz kartrid¿a w $2000/$3000"
  IDS_ATTACH_CBM2_CART_4000_5000   "Wsuñ obraz kartrid¿a w $4000/$5000"
  IDS_ATTACH_CBM2_CART_6000_7000   "Wsuñ obraz kartrid¿a w $6000/$7000"
  IDS_MI_LOAD_CART_1000            "Wczytaj nowy kartrid¿ $1***"
  IDS_MI_UNLOAD_CART_1000          "Usuñ kartrid¿ $1***"
  IDS_MI_LOAD_CART_2000_3000       "Wczytaj nowy kartrid¿ $2-3***"
  IDS_MI_UNLOAD_CART_2000_3000     "Usuñ kartrid¿ $2-3***"
  IDS_MI_LOAD_CART_4000_5000       "Wczytaj nowy kartrid¿ $4-5***"
  IDS_MI_UNLOAD_CART_4000_5000     "Usuñ kartrid¿ $4-5***"
  IDS_MI_LOAD_CART_6000_7000       "Wczytaj nowy kartrid¿ $6-7***"
  IDS_MI_UNLOAD_CART_6000_7000     "Usuñ kartrid¿ $6-7***"
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
#endif
...
BEGIN
  ...
  IDS_ATTACH_CBM2_CART_4000_5000   "Attach cartridge image at $4000/$5000"
  IDS_ATTACH_CBM2_CART_6000_7000   "Attach cartridge image at $6000/$7000"
  IDS_MI_LOAD_CART_1000            "·ÐÓàã×Øâì ÝÞÒëÙ ÚÐàâàØÔÖ $1***"
  IDS_MI_UNLOAD_CART_1000          "¸×ÒÛÕçì ÚÐàâàØÔÖ $1***"
  IDS_MI_LOAD_CART_2000_3000       "·ÐÓàã×Øâì ÝÞÒëÙ ÚÐàâàØÔÖ $2-3***"
  IDS_MI_UNLOAD_CART_2000_3000     "¸×ÒÛÕçì ÚÐàâàØÔÖ $2-3***"
  IDS_MI_LOAD_CART_4000_5000       "·ÐÓàã×Øâì ÝÞÒëÙ ÚÐàâàØÔÖ $4-5***"
  IDS_MI_UNLOAD_CART_4000_5000     "¸×ÒÛÕçì ÚÐàâàØÔÖ $4-5***"
  IDS_MI_LOAD_CART_6000_7000       "·ÐÓàã×Øâì ÝÞÒëÙ ÚÐàâàØÔÖ $6-7***"
  IDS_MI_UNLOAD_CART_6000_7000     "¸×ÒÛÕçì ÚÐàâàØÔÖ $6-7***"
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
#endif
...
BEGIN
  ...
  IDS_MI_LOAD_CART_1000            "Läs ny insticksmodul $1***"
  IDS_MI_UNLOAD_CART_1000          "Läs ur insticksmodul $1***"
  IDS_MI_LOAD_CART_2000_3000       "Läs ny insticksmodul $2-3***"
  IDS_MI_UNLOAD_CART_2000_3000     "Läs ur insticksmodul $2-3***"
  IDS_MI_LOAD_CART_4000_5000       "Läs ny insticksmodul $4-5***"
  IDS_MI_UNLOAD_CART_4000_5000     "Läs ur insticksmodul $4-5***"
  IDS_MI_LOAD_CART_6000_7000       "Läs ny insticksmodul $6-7***"
  IDS_MI_UNLOAD_CART_6000_7000     "Läs ur insticksmodul $6-7***"
END
...
BEGIN
  IDS_MODEL_LINE                   "Model hattý"
  IDS_SELECT_CBMII_MEM_128         "128 kByte"
  IDS_SELECT_CBMII_MEM_256         "256 kByte"
  IDS_SELECT_CBMII_MEM_512         "512 kByte"
  IDS_SELECT_CBMII_MEM_1024        "1024 kByte"
  IDS_CBM2_RAM_BANKS               "RAM banklarý"
  IDS_TOGGLE_CBMII_RAM08           "Bank 15 $0800-$0FFF RAM"
  IDS_TOGGLE_CBMII_RAM1            "Bank 15 $1000-$1FFF RAM"
  IDS_TOGGLE_CBMII_RAM2            "Bank 15 $2000-$3FFF RAM"
  IDS_TOGGLE_CBMII_RAM4            "Bank 15 $4000-$5FFF RAM"
  IDS_TOGGLE_CBMII_RAM6            "Bank 15 $6000-$7FFF RAM"
  IDS_TOGGLE_CBMII_RAMC            "Bank 15 $C000-$CFFF RAM"
  IDS_ATTACH_CBM2_CART_1000        "$1000 adresine kartuþ imajý yerleþtir"
  IDS_ATTACH_CBM2_CART_2000_3000   "$2000/$3000 adresine kartuþ imajý yerleþtir"
  IDS_ATTACH_CBM2_CART_4000_5000   "$4000/$5000 adresine kartuþ imajý yerleþtir"
  IDS_ATTACH_CBM2_CART_6000_7000   "$6000/$7000 adresine kartuþ imajý yerleþtir"
  IDS_MI_LOAD_CART_1000            "Yeni Kartuþ $1*** yükle"
  IDS_MI_UNLOAD_CART_1000          "Kartuþ $1*** kaldýr"
  IDS_MI_LOAD_CART_2000_3000       "Yeni Kartuþ $2-3*** yükle"
  IDS_MI_UNLOAD_CART_2000_3000     "Kartuþ $2-3*** kaldýr"
  IDS_MI_LOAD_CART_4000_5000       "Yeni Kartuþ $4-5*** yükle"
  IDS_MI_UNLOAD_CART_4000_5000     "Kartuþ $4-5*** kaldýr"
  IDS_MI_LOAD_CART_6000_7000       "Yeni Kartuþ $6-7*** yükle"
  IDS_MI_UNLOAD_CART_6000_7000     "Kartuþ $6-7*** kaldýr"
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
#endif
