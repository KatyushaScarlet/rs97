...
BEGIN
  ...
  IDS_SID_GENGROUP3           N_("Extra SID chips")
  IDS_SID_EXTRA_AMOUNT_LABEL  N_("Amount of extra SID chips")
  IDS_SID_STEREOADDRESS_LABEL N_("Second SID at")
  IDS_SID_TRIPLEADDRESS_LABEL N_("Third SID at")
  IDS_SID_RESID_GROUP         N_("reSID options")
  IDS_SID_RESID_SAMPLE        N_("Sample method")
  IDS_SID_RESID_PASSBAND      N_("Passband")
  IDS_HARDSID_GROUP           N_("Device selection")
  IDS_HARDSID_LEFT_LABEL      N_("Left/Main device")
  IDS_HARDSID_RIGHT_LABEL     N_("Right device")
END
...
BEGIN
  ...
  IDS_SID_STEREOADDRESS_LABEL "Anden SID på"
  IDS_SID_TRIPLEADDRESS_LABEL "Tredie SID på"
  IDS_SID_RESID_GROUP         "reSID options"
  IDS_SID_RESID_SAMPLE        "Samplingmetode"
  IDS_SID_RESID_PASSBAND      "Pasbånd (0..90%)"
  IDS_HARDSID_GROUP           "Enhedsvalg"
  IDS_HARDSID_LEFT_LABEL      "Venstre/hovedenhed"
  IDS_HARDSID_RIGHT_LABEL     "Højre enhed"
END
...
BEGIN
  ...
  IDS_HARDSID_GROUP           "Geräte Auswahl"
  IDS_HARDSID_LEFT_LABEL      "Links/Haupt Gerät"
  IDS_HARDSID_RIGHT_LABEL     "Rechtes Gerät"
END
...
BEGIN
  ...
  IDS_FAST_RESAMPLING         "Remuestreo rápido"
  ...
  IDS_SID_RESID_GROUP         "reSID options"
  IDS_SID_RESID_SAMPLE        "Método de muestreo"
  IDS_SID_RESID_PASSBAND      "Pasabanda (0..90%)"
  IDS_HARDSID_GROUP           "Selección de periférico"
  IDS_HARDSID_LEFT_LABEL      "Periférico Izquierda/Principal"
  IDS_HARDSID_RIGHT_LABEL     "Periférico derecho"
END
...
BEGIN
  IDS_GENERAL                 "Général"
  IDS_SID_SETTINGS            "Paramètres SID"
  IDS_FAST                    "Rapide"
  IDS_INTERPOLATING           "Par interpolation"
  IDS_RESAMPLING              "Rééchantillonnage"
  IDS_FAST_RESAMPLING         "Rééchantillonage rapide"
  IDS_SID_GENGROUP3           "Puces SID supplémentaires"
  IDS_SID_EXTRA_AMOUNT_LABEL  "Quantité de puces SID supplémentaires"
  IDS_SID_STEREOADDRESS_LABEL "Second SID à"
  IDS_SID_TRIPLEADDRESS_LABEL "Troisième SID à"
  IDS_SID_RESID_GROUP         "reSID options"
  IDS_SID_RESID_SAMPLE        "Méthode d'échantillonnage"
  IDS_SID_RESID_PASSBAND      "Bande passante (0..90%)"
  IDS_HARDSID_GROUP           "Sélection des périphériques"
  IDS_HARDSID_LEFT_LABEL      "Périphérique gauche/principal"
  IDS_HARDSID_RIGHT_LABEL     "Périphérique droit"
END
...
BEGIN
  IDS_GENERAL                 "Általános"
  IDS_SID_SETTINGS            "SID beállításai"
  IDS_FAST                    "Fast"
  ...
  IDS_SID_RESID_GROUP         "reSID options"
  IDS_SID_RESID_SAMPLE        "Mintavételezés módja"
  IDS_SID_RESID_PASSBAND      "Passband (0..90%)"
  IDS_HARDSID_GROUP           "Eszközök kiválasztása"
  IDS_HARDSID_LEFT_LABEL      "Bal oldali/fõ eszköz"
  IDS_HARDSID_RIGHT_LABEL     "Jobb oldali eszköz"
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
#endif
...
BEGIN
  IDS_GENERAL                 "Á¦³Ê·²"
  IDS_SID_SETTINGS            "SID ¼³Á¤"
  IDS_FAST                    "ºü¸¥"
  IDS_INTERPOLATING           "º¸°£ÇÏ´Ù"
  IDS_RESAMPLING              "¸®»ùÇÃ¸µ"
  IDS_FAST_RESAMPLING         "ºü¸¥ ¸®¼Àºí¸µ"
  IDS_SID_GENGROUP3           "Extra SID chips"
  IDS_SID_EXTRA_AMOUNT_LABEL  "Amount of extra SID chips"
  IDS_SID_STEREOADDRESS_LABEL "Second SID at"
  IDS_SID_TRIPLEADDRESS_LABEL "Third SID at"
...
BEGIN
  ...
  IDS_SID_EXTRA_AMOUNT_LABEL  "Liczba dodatkowych czipów SID"
  ...
  IDS_HARDSID_GROUP           "Wybór urz±dzenia"
  IDS_HARDSID_LEFT_LABEL      "Lewe/G³ówne urz±dzenie"
...
BEGIN
  IDS_GENERAL                 "General"
  IDS_SID_SETTINGS            "½ÐáâàÞÙÚØ SID"
  IDS_FAST                    "Fast"
  IDS_INTERPOLATING           "Interpolating"
  IDS_RESAMPLING              "Resampling"
  IDS_FAST_RESAMPLING         "Fast resampling"
  IDS_SID_GENGROUP3           "Extra SID chips"
  IDS_SID_EXTRA_AMOUNT_LABEL  "ºÞÛØçÕáâÒÞ ÔÞßÞÛÝØâÕÛìÝëå SID çØßÞÒ"
  IDS_SID_STEREOADDRESS_LABEL "Second SID at"
  IDS_SID_TRIPLEADDRESS_LABEL "Third SID at"
  IDS_SID_RESID_GROUP         "reSID options"
  IDS_SID_RESID_SAMPLE        "Sample method"
  IDS_SID_RESID_PASSBAND      "Passband (0..90%)"
  IDS_HARDSID_GROUP           "²ëÑÞà ãáâàÞÙáâÒÐ"
  IDS_HARDSID_LEFT_LABEL      "Left/Main device"
  IDS_HARDSID_RIGHT_LABEL     "Right device"
END
#ifndef WINDRES_CP_IGNORE
...
BEGIN
  IDS_GENERAL                 "Allmänt"
  IDS_SID_SETTINGS            "SID-inställningar"
  IDS_FAST                    "Snabbt"
  ...
  IDS_SID_STEREOADDRESS_LABEL "Andra SID på"
  IDS_SID_TRIPLEADDRESS_LABEL "Tredje SID på"
  IDS_SID_RESID_GROUP         "reSID options"
  IDS_SID_RESID_SAMPLE        "Samplingsmetod"
  IDS_SID_RESID_PASSBAND      "Passband (0..90%)"
  IDS_HARDSID_GROUP           "Välj enhet"
  IDS_HARDSID_LEFT_LABEL      "Vänster/huvudenhet"
  IDS_HARDSID_RIGHT_LABEL     "Höger enhet"
END
...
BEGIN
  IDS_GENERAL                 "Genel"
  IDS_SID_SETTINGS            "SID ayarlarý"
  IDS_FAST                    "Hýzlý"
  IDS_INTERPOLATING           "Ara deðer bulma"
  IDS_RESAMPLING              "Yeniden örnekleme"
  IDS_FAST_RESAMPLING         "Hýzlý yeniden örnekleme"
  IDS_SID_GENGROUP3           "Ekstra SID çipleri"
  IDS_SID_EXTRA_AMOUNT_LABEL  "Ekstra SID çip adedi"
  IDS_SID_STEREOADDRESS_LABEL "Ýkinci SID konumu"
  IDS_SID_TRIPLEADDRESS_LABEL "Üçüncü SID konumu"
  IDS_SID_RESID_GROUP         "reSID options"
  IDS_SID_RESID_SAMPLE        "Örnekleme metodu"
  IDS_SID_RESID_PASSBAND      "Passband (0..90%)"
  IDS_HARDSID_GROUP           "Aygýt seçimi"
  IDS_HARDSID_LEFT_LABEL      "Sol/Ana aygýt"
  IDS_HARDSID_RIGHT_LABEL     "Sað aygýt"
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
#endif
